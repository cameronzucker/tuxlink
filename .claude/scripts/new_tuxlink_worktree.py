...
def main() -> int:
    ...
    print("  git status --short && git ls-files --others --exclude-standard && git stash list")
    print("  # if any at-risk content: commit + push OR tar czf .claude/worktree-archives/<name>-<ts>.tar.gz <path>")
    print(f'  cd "{repo}"')
