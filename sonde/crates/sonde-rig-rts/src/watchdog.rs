...
//! Without external safety, a SIGKILL of `sonde-tx` mid-transmission
...
//! function. The `sonde-rig-watchdog` binary wires it to real Linux
...
/// auto-releasing. Mirrors the cap in [`crate::bin::sonde_rig_rts::HARD_CAP_SECS`].
