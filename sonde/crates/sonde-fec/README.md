...
- **OFDM-family rate-compatible codes (n=648, n=1296; rates 1/2, 2/3, 3/4, 5/6).**
  ...
  is the open-standard reference; sonde's parameters are independently
...
`sonde-phy::coded_modulation`. The trait is the bus contract; this
crate provides the concrete implementations.

```rust
use sonde_fec::{FloorRate14Codec, OfdmAdaptiveCodec, WifiLdpcRate};
