...
// string union; declare it locally — a string literal is structurally assignable to
// startResizeDragging's parameter. A borderless (decorations:false) GTK window has no
// native resize grips (spec §5); these invisible edge/corner handles call
