...
29. `cargo xtask gen-corpus` produces ~1.5–2 MB of synthetic events at `dev/log-corpus-synthetic/`, including the real-string fixtures listed in §7.3.
30. `cargo xtask train-log-dict` produces `src-tauri/assets/logging/tuxlink-events-v1.zdict` (~16 KB).
