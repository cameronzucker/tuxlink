...
- [`2026-06-02-wle-client-parity-closure-plan.md`](2026-06-02-wle-client-parity-closure-plan.md) — **closure plan synthesis**. Sequences the 15 connection-mode bd issues into 3 tiers + names operator-decision gates + propagates the 3 audit corrections downstream. **Amended 2026-06-03 — see below.**
- [`2026-06-03-multi-transport-listener-architecture.md`](2026-06-03-multi-transport-listener-architecture.md) — **listener architecture + closure-plan amendment**. Corrects the "inbound P2P parity = Telnet-P2P only" framing: every P2P-capable transport needs the receive side (TNC/modem owns the listen; tuxlink handles the receive-side wiring + WLE-divergent allowlist+auth overlay). Re-sequences Tier 1, files 3 new bd issues, scope-corrects 5 existing ones.
- [`2026-06-10-winlink-express-help-gap-audit.md`](2026-06-10-winlink-express-help-gap-audit.md) — **CHM help corpus docs audit**. Mines the legacy Winlink Express help file as an operator-documentation coverage map, preserving raw/extracted help only under gitignored `dev/winlink-reference/` and tracking paraphrased gaps/follow-ups for Tuxlink docs.
