//! tux-rig-rts — CLI for the serial-RTS PTT primitive.
//!
...
//!
//! ```text
//! tux-rig-rts toggle  --device <path>                — assert briefly then release
//! tux-rig-rts assert  --device <path> --duration <s> — assert for at most N seconds
//! tux-rig-rts release --device <path>                — release explicitly
//! ```
//!
//! ## Safety
//!
...
use tux_rig_rts::{LinuxTty, Ptt, PttState, RtsError, RtsPtt};
...
const USAGE: &str = "\
tux-rig-rts — serial-RTS PTT control for Digirig / SignaLink-RTS / CP2102-class adapters

USAGE:
    tux-rig-rts <COMMAND> --device <PATH> [OPTIONS]
