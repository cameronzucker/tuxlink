// VENDORED VERBATIM from origin/main:src-tauri/src/winlink/ax25/uvpro/audio/sbc.rs
// (tuxlink-vgvn, merged PR #673) — for the tuxlink-st5n decisive round-trip gate ONLY.
// Test-harness copy; canonical codec lives in src-tauri. Do NOT let it drift.
// Edits from original: SbcCodec trait inlined; inner doc comments (//!) -> //; test mod stripped.
#![allow(dead_code)]
#![allow(clippy::all)]
