...
// Representative catalog: a WA state forecast (so the location hero's State
// forecast card resolves), a couple EASTPAC marine entries, propagation, and
// gateway lists — enough categories that browse + chips populate realistically.
