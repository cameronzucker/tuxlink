...
| pi5 | thenlper/gte-small | desc | 0.861 | 0.944 | 0.917 | 1049.8/1566.1 | 3800.42 | 900.5 | 0.0657/0.0066 | max 0.8706 vs min 0.8467 |
| pi5 | thenlper/gte-small | sec_desc | 0.944 | 0.972 | 0.972 | 1022.9/1539.0 | 4318.02 | 900.5 | 0.0603/0.0054 | max 0.8413 vs min 0.8403 |
| pi5 | thenlper/gte-small | full | 0.944 | 0.972 | 0.972 | 1042.1/1547.8 | 5890.68 | 900.5 | 0.0603/0.0044 | max 0.8315 vs min 0.8457 |
...
Pi gte-small arm completed after the initial commit: accuracy replicates R2 (0.944 top-1 sec_desc) but its batch path is pathological on the Pi (4318s = 72min per template precompute vs bge's 49s; per-query 1023ms median) — reinforcing the model-specific batch-slowness seen on R2 and disqualifying gte for any Pi-floor role.
