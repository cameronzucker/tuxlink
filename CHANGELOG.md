...
* **agent-frontend:** add AgentEndpoint with userinfo rejection + is_loopback/origin ([152b93b](https://github.com/cameronzucker/tuxlink/commit/152b93bc28ced91f5a2af17de16bec6dd0e324d7))
* **agent-frontend:** ApiKey redacting newtype + error-body value-scrub ([26bed46](https://github.com/cameronzucker/tuxlink/commit/26bed4633f453dda26266d3eba1c7021edcdd993))
* **agent-frontend:** shared build_vetted_client egress policy for Elmer model endpoints ([a688e61](https://github.com/cameronzucker/tuxlink/commit/a688e613ba8b6dea35c2e72d18aae3a4bd70b5c2))
* **controls:** freeze the Button/Select/Field barrel export (tuxlink-3m0vx) ([893f90c](https://github.com/cameronzucker/tuxlink/commit/893f90cf50cc131bd0a291b37730ed06ca8a1a45))
* **controls:** typed Button wrapper over controls.css (tuxlink-3m0vx) ([4873358](https://github.com/cameronzucker/tuxlink/commit/4873358523ec4afe7a5105a56abb65ee653ef62f))
* **controls:** typed Field wrapper over controls.css (tuxlink-3m0vx) ([ea5e833](https://github.com/cameronzucker/tuxlink/commit/ea5e833992d9394eec534d66ebc21fffb26cec18))
* **controls:** typed Select wrapper with baked chevron (tuxlink-3m0vx) ([b5225d0](https://github.com/cameronzucker/tuxlink/commit/b5225d044544c8065d940eaaaa77c185a3b61deb))
* **design-system:** add --ctl-accent context-token trio (tuxlink-3m0vx) ([c0c62e0](https://github.com/cameronzucker/tuxlink/commit/c0c62e083cc7a66ccf03ff42ab582174e7f57212))
* **design-system:** reconcile controls.css onto the normalized tone/emphasis/size scale (tuxlink-3m0vx) ([c410867](https://github.com/cameronzucker/tuxlink/commit/c410867939e4813900974e2707e76441cf472e60))
* **elmer-distill:** dataset assembler (Harmony JSONL + assistant-loss spans + P95 seq stats) ([b726e9e](https://github.com/cameronzucker/tuxlink/commit/b726e9ef6a1f263f663b7f1ebac565090a058683))
* **elmer-distill:** G0 prompt-only baseline (few-shot + checklist + verifier loop) ([41078bc](https://github.com/cameronzucker/tuxlink/commit/41078bcd51b87dec3e4589cd25a3b126769a3987))
* **elmer-distill:** Harmony render + round-trip parse via official openai_harmony ([5fa3d2c](https://github.com/cameronzucker/tuxlink/commit/5fa3d2c062d8f47acfeb79f4fa5977c9990c0ebb))
* **elmer-distill:** judge scores trajectory vs SuccessSpec (order/staging/egress replay) ([ec99154](https://github.com/cameronzucker/tuxlink/commit/ec99154ea7a302ecf7c2c69c31644cde9dfe4a22))
* **elmer-distill:** ollama client + G1 teacher-capture runner (yield by coverage cell) ([9cd01c2](https://github.com/cameronzucker/tuxlink/commit/9cd01c2c8907f9444dc188d063e50844778d3da0))
* **elmer-distill:** Scenario + SuccessSpec schema with blended emcomm fixture ([fbb7961](https://github.com/cameronzucker/tuxlink/commit/fbb7961e34d5e06ef2bfaa031aeffc521be6c649))
* **elmer-distill:** scenario bank generator + task-graph holdout split ([3bdc0fe](https://github.com/cameronzucker/tuxlink/commit/3bdc0fe481d5614d1f2188972b3b870c90c761cf))
* **elmer-distill:** stateful simulator (armed-authority + taint + outbox) ([037cd2d](https://github.com/cameronzucker/tuxlink/commit/037cd2d7edff2b18d1ad07a6e595e5d5d4680ddb))
* **elmer-distill:** tool-surface classification (taint/egress/tier2/staging/stop) ([2ca417e](https://github.com/cameronzucker/tuxlink/commit/2ca417e8467014f9380c7ac63b9843db5681a52d))
* **elmer-ui:** add "Set up Elmer's model…" Tools entry → opens Elmer with the Model section expanded ([7247ef9](https://github.com/cameronzucker/tuxlink/commit/7247ef9069e2690ac8bcd422c2e8c42b75c6e95c))
* **elmer-ui:** empty-state Connect-a-model button, detect remedies, model attribution marker ([1490197](https://github.com/cameronzucker/tuxlink/commit/14901979f2020f7b8fb72a73958f8e34cfb297a2))
* **elmer-ui:** Model form — preset/endpoint/key-affordance/model+Detect, Save & use ([fc27a02](https://github.com/cameronzucker/tuxlink/commit/fc27a02c48db9eca20f65c58b0d28077336cc1ff))
* **elmer-ui:** model-config presets + origin-based preset inference ([58d22ac](https://github.com/cameronzucker/tuxlink/commit/58d22ac44a33b0e3a59c7422a8d80941483e7963))
* **elmer:** add "New conversation" reset to reclaim context (header icon) ([974fc13](https://github.com/cameronzucker/tuxlink/commit/974fc134e5ef6c8b36d8498a57c866d2640fcfad))
* **elmer:** Advanced disclosure UI + saved-value pre-fill wiring (T8) ([6fb0e8b](https://github.com/cameronzucker/tuxlink/commit/6fb0e8b2b6b11f9b7dcfbbc02b9a185dcb562e9e))
* **elmer:** agent-runner streaming foundation — AssistantDelta/ReasoningDelta (tuxlink-e2vw7 phase 1a) ([9d59771](https://github.com/cameronzucker/tuxlink/commit/9d59771bcb7025754121ab780fd487ff7b547b85))
* **elmer:** allowlist provider key-page URLs for the get-a-key flow ([c6e4e5a](https://github.com/cameronzucker/tuxlink/commit/c6e4e5adb3547602445ad017b96dc5a182afdc03))
* **elmer:** Anthropic preset, per-preset tier/keyPage/default-model, TS DTO contract ([31f48f5](https://github.com/cameronzucker/tuxlink/commit/31f48f51b226c36354fa65bd8003d1717d1ee305))
* **elmer:** bridge ContextUsage → ElmerEvent::Context on elmer-context channel (T5) ([c4f0664](https://github.com/cameronzucker/tuxlink/commit/c4f0664d4d27d329eba6868cd3d28bd8bf3c3876))
* **elmer:** bridge streaming deltas to an EV_DELTA Tauri event (tuxlink-e2vw7 phase 2a) ([1af5d92](https://github.com/cameronzucker/tuxlink/commit/1af5d92ef312bdda070a9dc438f808ba455ab301))
* **elmer:** classify HTTP 429 as a typed rate-limit signal ([75899cf](https://github.com/cameronzucker/tuxlink/commit/75899cfdcbedf2f8b071b6969d489a3d11df3005))
* **elmer:** context-fullness meter above the composer (T7) ([f25cfb8](https://github.com/cameronzucker/tuxlink/commit/f25cfb806bedacb171a2e1b7b119e4177c7fcfec))
* **elmer:** Detect model list on cloud tiles (pick, don't hand-type) ([2889279](https://github.com/cameronzucker/tuxlink/commit/2889279c5f6ebebc0462a8a1e9c0bafe09622423))
* **elmer:** elmer_config_read/set Tauri commands — transactional, key never returned ([3fc7e24](https://github.com/cameronzucker/tuxlink/commit/3fc7e2499b5817f48bf0579a60918a6e53bcc39f))
* **elmer:** elmer_detect_models — KeySource, derived /models URL, fixed auth reason, value-scrub ([6d35262](https://github.com/cameronzucker/tuxlink/commit/6d352625cb3f6d300b873de938ea17fb0904b9fa))
* **elmer:** ElmerModelConfigState atomic {endpoint,model} lock for live-apply ([483721c](https://github.com/cameronzucker/tuxlink/commit/483721c987fc7656ef30749e23aebc963c8160ff))
* **elmer:** ElmerProvider::new_vetted routes the model client through build_vetted_client ([81ab897](https://github.com/cameronzucker/tuxlink/commit/81ab89765b80491039d3ce06cae226e618155650))
* **elmer:** free-key cloud presets — Google Gemini + Groq ([aab35c2](https://github.com/cameronzucker/tuxlink/commit/aab35c20b143ae5682befaaa69a1a7798a8f5ac6))
* **elmer:** free-key cloud presets — Google Gemini + Groq ([a9a2aab](https://github.com/cameronzucker/tuxlink/commit/a9a2aabe84a299c0129320b31d32ebdaafd0e0d9))
* **elmer:** guided get-a-free-key flow with masked key entry ([dd4247b](https://github.com/cameronzucker/tuxlink/commit/dd4247be6155f45d9a8b42f2d1025cb0784f154e))
* **elmer:** live streaming render — tokens + collapsible reasoning (tuxlink-e2vw7 phase 2b) ([a7f8cd5](https://github.com/cameronzucker/tuxlink/commit/a7f8cd5973d8c1391de0c384f52bf18e146dbc9b))
* **elmer:** live token/reasoning streaming (tuxlink-e2vw7) [WIP] ([4dee5fe](https://github.com/cameronzucker/tuxlink/commit/4dee5fe5eb4c38d6726e8feef0200067884ac831))
...
* **elmer:** ModelTilePicker component (tiered tiles, key-saved badges, ModelForm reuse) ([77f82ad](https://github.com/cameronzucker/tuxlink/commit/77f82ad5b3a167ae9247dbed6d7882180996e2e4))
* **elmer:** native Anthropic Messages API adapter (Claude is not OpenAI-compatible) ([c3375c3](https://github.com/cameronzucker/tuxlink/commit/c3375c3bce539267e0e3d66009fa8260116675c7))
* **elmer:** native Ollama /api/chat provider adapter + ContextUsage event (T1/T2) ([5cd3aed](https://github.com/cameronzucker/tuxlink/commit/5cd3aed638295d36e283fc3263319c80b8cf31d5))
* **elmer:** Ollama memory-fit estimate command (T6) ([d15435f](https://github.com/cameronzucker/tuxlink/commit/d15435ffba5d8babf826b3a06f6e68b06b31bfd2))
* **elmer:** onboarded sentinel distinguishes never-configured from implicit default ([9932119](https://github.com/cameronzucker/tuxlink/commit/9932119fc15db79000393515aa680ba3fafa207b))
* **elmer:** OpenAiProvider streams tokens via SSE (tuxlink-e2vw7 phase 1b) ([186ca80](https://github.com/cameronzucker/tuxlink/commit/186ca80c1c08934d25a258615d4f7ade2c655076))
* **elmer:** operator-adjustable per-turn timeout + responsive mid-turn Stop ([f5b181d](https://github.com/cameronzucker/tuxlink/commit/f5b181d43398cf472cbcb9b4ac700a925b8d3cb4))
* **elmer:** operator-adjustable per-turn timeout from the Model form ([b3111a9](https://github.com/cameronzucker/tuxlink/commit/b3111a9c844b48503527ad4c1573feebbd12152c))
* **elmer:** origin-keyed API-key keyring (read/set/clear/status, fail-closed) ([49fb8fb](https://github.com/cameronzucker/tuxlink/commit/49fb8fbde26d054895f63c5019821d19ed1d8e59))
* **elmer:** per-origin key-status lookup for per-tile key-saved badges ([cc10c2c](https://github.com/cameronzucker/tuxlink/commit/cc10c2c2a84136563740a25132c0c43bc8865775))
* **elmer:** per-reply Copy button + selectable message text ([389b2bf](https://github.com/cameronzucker/tuxlink/commit/389b2bf63ec7dd43a5ca51973435a2611ba9df2d))
* **elmer:** per-turn provider build under the model-config lock; NeedsOperator on failure (no panic) ([8394cd0](https://github.com/cameronzucker/tuxlink/commit/8394cd0c5809f9a3a1417e92a1d7ec2dfa64bdd5))
* **elmer:** probe-with-fallback Ollama selection + config threading (T4) ([484459b](https://github.com/cameronzucker/tuxlink/commit/484459b6c09ca02b366d3453c43312ea38baff15))
* **elmer:** radio-themed "thinking" indicator with cycling verbs + elapsed timer ([f38dfab](https://github.com/cameronzucker/tuxlink/commit/f38dfabdce16f84943006bce276ad0af695b0346))
* **elmer:** radio-verb thinking indicator + markdown-rendered responses ([03cbac7](https://github.com/cameronzucker/tuxlink/commit/03cbac7746ee4137eef44069d8d32b9e40a9e3b7))
* **elmer:** rate-limit recovery, honest framing, persistent provider indicator, single-column layout ([5aeffc8](https://github.com/cameronzucker/tuxlink/commit/5aeffc82cad9d8873642ca21e6ed6ff0d999cf15))
* **elmer:** register config commands (Tauri-only) + boundary note ([38ec038](https://github.com/cameronzucker/tuxlink/commit/38ec03824e244889face28e04a45b7f9bf63af78))
* **elmer:** render assistant turns as sanitized markdown ([5144e01](https://github.com/cameronzucker/tuxlink/commit/5144e01ee08f84070ac53809dd2388fda09c640d))
* **elmer:** store num_ctx/temperature/system_prompt_override config (T3) ([4afe5c8](https://github.com/cameronzucker/tuxlink/commit/4afe5c87e27fc5fc08d5ec1736622e068c1e758b))
* **elmer:** system prompt + arm label tell the truth — Elmer can send when armed (tuxlink-sg5zw.4) ([71d757d](https://github.com/cameronzucker/tuxlink/commit/71d757d2a55386992ad2a264740e4eba339b6dae))
* **elmer:** thread temperature into OpenAI + Anthropic bodies (T9) ([5163d89](https://github.com/cameronzucker/tuxlink/commit/5163d89c73d3963bb50529145e418b3857bb3fda))
* **elmer:** tile picker is the first-run + settings surface; chat gated until onboarded; gear reopens after mount ([6e8b0bb](https://github.com/cameronzucker/tuxlink/commit/6e8b0bb45897ddf3685245ee9f5de8ce8863c5d7))
* **elmer:** tile picker is the settings surface too (spec Approach A: full guided everywhere) ([baababe](https://github.com/cameronzucker/tuxlink/commit/baababe53aaebcb1e09a7a47b95057fdcaed2022))
* **elmer:** tile/provider switch pre-fills the default model, preserving hand-edits ([adfe29c](https://github.com/cameronzucker/tuxlink/commit/adfe29ce285cbc9275979ec6cff179bf3b1321a3))
* **elmer:** un-withhold egress tools; gate at guarded_egress not the tool list (tuxlink-sg5zw.1) ([feda892](https://github.com/cameronzucker/tuxlink/commit/feda892de5463b0ff7fcfdc969b0bf67b13969cd))


### Bug Fixes

* **agent-frontend:** permit `localhost` model endpoint (named-host loopback) ([6ea5803](https://github.com/cameronzucker/tuxlink/commit/6ea58038fecead75dc0856b3c78dcb5be76c385a))
* **agent-frontend:** scrub key before truncating; deny 0.0.0.0/8 (Codex G1 P2) ([519c3f8](https://github.com/cameronzucker/tuxlink/commit/519c3f893837f9a4e85523444f8dda71c8911426))
* **build:** add futures-util lock edge so clippy --locked passes (tuxlink-e2vw7 hotfix) ([8d616c7](https://github.com/cameronzucker/tuxlink/commit/8d616c724f069a0d3b7d7b22f60c45b71131c0d5))
* **build:** Cargo.lock futures-util edge — unbreak main after [#979](https://github.com/cameronzucker/tuxlink/issues/979) (tuxlink-e2vw7) ([6c878b0](https://github.com/cameronzucker/tuxlink/commit/6c878b0dc88d7fefa3ea0080809d19c3c9ebd190))
* **design-system:** keep compact-media accessibility floors as raw px (tuxlink-zj9se) ([768b562](https://github.com/cameronzucker/tuxlink/commit/768b5621fe51201b9fcb40ecdc1ec1055ab5a0da))
* **elmer-distill:** ground scenariogen prompts + taint-consistent specs + de-circularize G0 ([5b82074](https://github.com/cameronzucker/tuxlink/commit/5b8207441476022cd9d0145812d3eeb744fc0b20))
* **elmer-ui:** bind key actions + Detect to the endpoint origin (final Codex) ([5068397](https://github.com/cameronzucker/tuxlink/commit/5068397e4535adf2ed193cf7edb706f89f851bbc))
* **elmer-ui:** distinct testid for the key-clear Cancel button (G2 review) ([7a20409](https://github.com/cameronzucker/tuxlink/commit/7a20409285ab08738cddd3121009443dac3b077d))
* **elmer-ui:** model selection persists across Model-section collapse/re-expand ([28f20eb](https://github.com/cameronzucker/tuxlink/commit/28f20eb76b450d23177d8e54a486665819747c8c))
* **elmer-ui:** model selection persists across Model-section collapse/re-expand ([e219f43](https://github.com/cameronzucker/tuxlink/commit/e219f4303d366f6ee16cfcfc9214717caf889d24))
* **elmer:** accept object-form function.arguments in OpenAI-compat provider ([5f87f26](https://github.com/cameronzucker/tuxlink/commit/5f87f26058fdc6b97644a9b5f1efae71aebc697f))
* **elmer:** address Codex adrev P2 — real-path 429, path-tight allowlist, primary-flow key badges ([c2fe168](https://github.com/cameronzucker/tuxlink/commit/c2fe168343234e26afe1bea4708faf760a53fb45))
* **elmer:** agent uses the operator's set location (system prompt + position_status description) ([4a824d4](https://github.com/cameronzucker/tuxlink/commit/4a824d4658475e4c6552df37c0d826a49a7bcfde))
* **elmer:** auto-adopt first detected model when cleared so local model save persists ([620d165](https://github.com/cameronzucker/tuxlink/commit/620d165cf2344dc882ecca4cfa90198e0fb6ac7e))
* **elmer:** cap streamed tool-call bytes under MAX_TOTAL_OUTPUT_BYTES (Codex adrev) ([08a17df](https://github.com/cameronzucker/tuxlink/commit/08a17dfd131af0fd223d0288a4b27f666ff70f10))
* **elmer:** clear clippy -D warnings (dead_code field + too_many_arguments) ([20b2121](https://github.com/cameronzucker/tuxlink/commit/20b2121ab935e604f77fe4de38ba909f2e16fa0c))
* **elmer:** clear the unsaved key field when switching cloud tiles ([38448ae](https://github.com/cameronzucker/tuxlink/commit/38448ae97f222bedeacf254e4d0873945a5af618))
* **elmer:** closing the pane no longer orphans the inference (tuxlink-9uat6) ([04fd198](https://github.com/cameronzucker/tuxlink/commit/04fd1981bb46e2c31edc31d24cd464b1c0572149))
* **elmer:** cloud tile saves the correct model on provider switch; restore local Ollama detect/select ([0228ce3](https://github.com/cameronzucker/tuxlink/commit/0228ce3d58302ad078ee2191ed6345c45e3999d2))
* **elmer:** Codex G3 keyring hygiene (fail-closed detect, loopback-skip read) + clippy ([4e52f99](https://github.com/cameronzucker/tuxlink/commit/4e52f9952e6218f39600ab40b389383f3f6c9194))
* **elmer:** Codex-adrev Rust findings — native URL, string tool-args, KV default ([65a9135](https://github.com/cameronzucker/tuxlink/commit/65a9135dbe32e4b585c7b2cc5459ffeb05cc6fe8))
* **elmer:** conversational chat (stream turns/chips) + agent uses operator location ([b75bc23](https://github.com/cameronzucker/tuxlink/commit/b75bc23b6908915f6b8799c4e8e4bc48957f0352))
* **elmer:** Detect/Test sends the pasted key after an inter-provider switch ([5894b2c](https://github.com/cameronzucker/tuxlink/commit/5894b2cc5381217a602927c24fc01ea3ba1b7ac4))
* **elmer:** emit standard OpenAI tool-calling protocol so tool calls work on Gemini/strict providers ([c2d0ff1](https://github.com/cameronzucker/tuxlink/commit/c2d0ff158aa72bf32b75fc34d7f10b1582c16cf6))
* **elmer:** give cloud tiles an editable model field (unlock gpt-4o-mini, etc.) ([3b201d2](https://github.com/cameronzucker/tuxlink/commit/3b201d2a25963594bf98095237e44cee317ba6e0))
* **elmer:** ignore stale memory-estimate responses in Advanced panel ([8d87270](https://github.com/cameronzucker/tuxlink/commit/8d87270357c641a085c0dd2d394462146e3ef8d3))
* **elmer:** injection arm-gate test carries payload in target/call, not an unknown key ([dde51a6](https://github.com/cameronzucker/tuxlink/commit/dde51a6f5f8c7a9fb49aa19ab5e4501d13a26a63))
* **elmer:** inter-provider key no longer dropped (401) + surface config_set failures ([43a58a8](https://github.com/cameronzucker/tuxlink/commit/43a58a8712599e52311381f153b8be5745bb7c80))
* **elmer:** inter-provider key no longer dropped + surface config_set failures ([9410eae](https://github.com/cameronzucker/tuxlink/commit/9410eaecb72b3d0bec7c2c6a21811a2740f6d81c))
* **elmer:** keep the pane mounted (hidden) on close so a run isn't orphaned (tuxlink-9uat6) ([711ddb3](https://github.com/cameronzucker/tuxlink/commit/711ddb3c25ecaf44671ea708e1d61d63a95746dc))
* **elmer:** make Advanced settings reachable for the local Ollama tile ([8fb5b8b](https://github.com/cameronzucker/tuxlink/commit/8fb5b8b4bf8d40d8f90e8378e778b9f67b8fe7f0))
* **elmer:** make elmer_estimate_memory future Send; drop dead test accessor ([981e298](https://github.com/cameronzucker/tuxlink/commit/981e29819a3e0dcb30b9e9dfeb29909d9402441e))
* **elmer:** make the 'Custom…' provider option selectable + functional ([1bba195](https://github.com/cameronzucker/tuxlink/commit/1bba1956a4eb2dee15dff50fea3446838bb8d452))
* **elmer:** move provider_error_outcome test module to end-of-file (clippy items_after_test_module) ([be73a58](https://github.com/cameronzucker/tuxlink/commit/be73a580d18a1c453ccf085104a4f98b39dc1612))
* **elmer:** on_event must be Sync so the spawned run task stays Send (CI E0277) ([f97c169](https://github.com/cameronzucker/tuxlink/commit/f97c1690e171925e778c4b2182c57c2f639c23ec))
* **elmer:** persist all failed outcomes to the chat transcript, not just errors ([403928f](https://github.com/cameronzucker/tuxlink/commit/403928fc601a033cd2579c73ea554c8b8a77d639))
* **elmer:** persist errors in the transcript so they're capturable ([fe9df1a](https://github.com/cameronzucker/tuxlink/commit/fe9df1a0476933212b29046804f280f60814d40f))
* **elmer:** raise Anthropic max_tokens so thinking models don't truncate to empty ([a0a3aeb](https://github.com/cameronzucker/tuxlink/commit/a0a3aeb17325623411b1c3165396dcaefd53141b))
* **elmer:** raise per-turn timeout to 15 min (unblock large local models) ([2de345e](https://github.com/cameronzucker/tuxlink/commit/2de345e42070a1aacda652a33fc545e8d1aa01c9))
* **elmer:** raise the per-turn timeout to 15 min (unblock large local models) ([e455481](https://github.com/cameronzucker/tuxlink/commit/e45548157829ffc1cb8c20f375740ca9cc7e8f95))
* **elmer:** rebuild picker to approved mock; drop key format validation; strip Gemini endorsement; fix padding ([a94f45e](https://github.com/cameronzucker/tuxlink/commit/a94f45e44e455d66d0f502662fd57a3855ac4bc9))
* **elmer:** redacting Debug on SetKey + KeySource (type-level credential guard) ([2ba1ef7](https://github.com/cameronzucker/tuxlink/commit/2ba1ef7d5a1dbc63332c1df009c987715e3275f8))
* **elmer:** rename Outcome/Delta _kind fields to camelCase on the wire (tuxlink-e2vw7) ([dbd14ac](https://github.com/cameronzucker/tuxlink/commit/dbd14acd9358f89dd6b1ccf496b05d6663d087a0))
* **elmer:** return to chat on any picker save; correct stale seam comments ([e5f05fd](https://github.com/cameronzucker/tuxlink/commit/e5f05fd358f58da971f5bf266f1a4b3ddf75015e))
* **elmer:** robust listener cleanup — events no longer double-handled (tuxlink-hn5k6) ([91b2303](https://github.com/cameronzucker/tuxlink/commit/91b23039ce56bd70719d87210c7b906fb163dd40))
* **elmer:** robust listener cleanup so events aren't double-handled (tuxlink-hn5k6) ([0643250](https://github.com/cameronzucker/tuxlink/commit/064325010727614f4324e129d2dc5f842d291661))
* **elmer:** SSE byte-framing + bounds + clear streaming buffers on terminal outcome (tuxlink-e2vw7 adrev) ([57e7efd](https://github.com/cameronzucker/tuxlink/commit/57e7efd07b936aed1f76198d53aefe23770e3c8c))
* **elmer:** Stop interrupts an in-flight turn immediately (responsive cancellation) ([86efbcd](https://github.com/cameronzucker/tuxlink/commit/86efbcd0b12e937611b13f6d0d80fc4594dc7d3c))
* **elmer:** stream assistant turns + tool chips so the chat is conversational ([5062fe9](https://github.com/cameronzucker/tuxlink/commit/5062fe9ddc67a6c9188359c5dd971239a4bd0d97))
* **elmer:** stream native Ollama /api/chat — restore streaming regression (tuxlink-b7tkf) ([8c37c2a](https://github.com/cameronzucker/tuxlink/commit/8c37c2a4177a6b0d571a01ca62600f4a1598a448))
* **elmer:** switch-provider flow returns to chat (clear focus tier on save/cancel) ([5996887](https://github.com/cameronzucker/tuxlink/commit/59968873505512e7eb7ae4e4341919878ce48f2e))
* **elmer:** take &str in is_anthropic_endpoint to unblock main-crate build ([e393ea3](https://github.com/cameronzucker/tuxlink/commit/e393ea34503298c23518263140cfe03401929311))
* **elmer:** teach the agent the stage→Arm-to-send model (stop faked sends + fabrication) ([ff525b9](https://github.com/cameronzucker/tuxlink/commit/ff525b91b058dbead4db20fa4ab3d6b911fb5edd))
* **elmer:** teach the agent the stage→Arm-to-send model so it stops faking sends ([68bf319](https://github.com/cameronzucker/tuxlink/commit/68bf31971a35becd0824c7ca258188cfcb1ed7cb))
* **elmer:** test assertions don't require Debug on ElmerProvider / dyn Provider ([330fab6](https://github.com/cameronzucker/tuxlink/commit/330fab65e6b8357fc013d14ee4e7a6c6efc2f02c))
* **elmer:** unstrand cloud→local model switch + teach Elmer its full tool surface ([b1dfde9](https://github.com/cameronzucker/tuxlink/commit/b1dfde9a41f24c02b66adf7786b4bf370b11a678))
* **elmer:** use struct-update syntax in onboarded tests (clippy field_reassign_with_default) ([57423ee](https://github.com/cameronzucker/tuxlink/commit/57423ee5c2fed5b050358a984b5e340747ddf3dd))
* **render-harness:** import controls.css so migrated .tux-btn/.tux-field/.tux-select render (tuxlink-3m0vx) ([1a3e8fa](https://github.com/cameronzucker/tuxlink/commit/1a3e8fa0193c1c0fff86c972b03476797a5b7a81))


### Refactors

* **design-system:** migrate ARDOP/VARA mode panels onto tokens (tuxlink-zj9se) ([d3e1f20](https://github.com/cameronzucker/tuxlink/commit/d3e1f208748e8ca72f859c4ed4cdad766b020113))
* **design-system:** migrate inbound-selection panel onto tokens (tuxlink-zj9se) ([5d588c7](https://github.com/cameronzucker/tuxlink/commit/5d588c7afe9ee496b7a1fd6be51c51e2ed21e49a))
* **design-system:** migrate non-enumerated ribbon dash-* onto scale tokens (tuxlink-zj9se) ([ac267cd](https://github.com/cameronzucker/tuxlink/commit/ac267cd320c9f9675a738c76c491197c2183fb24))
* **design-system:** migrate radio-pane sections onto tokens (tuxlink-zj9se) ([10969ed](https://github.com/cameronzucker/tuxlink/commit/10969edcd2ce757ea8b8e81942ebb70067bda767))
* **design-system:** migrate radio-panel chrome onto tokens + kill stray flex:1 button (tuxlink-zj9se) ([cf5e805](https://github.com/cameronzucker/tuxlink/commit/cf5e805c288697f2e12ecea23e48eeca443b4fc7))
* **design-system:** migrate Sparkline gradients onto status tokens (tuxlink-ivzut) ([868bc8e](https://github.com/cameronzucker/tuxlink/commit/868bc8e5f78ddf15da4aff1ca1a3e93fcd358889))
* **elmer:** export ModelForm so the tile picker can reuse it verbatim ([cc9ec3b](https://github.com/cameronzucker/tuxlink/commit/cc9ec3b73b8b8d5387614f4faeccf3c9dc5de19f))
* **radio:** adopt Button wrapper on radio-pane footers + restore compact a11y floor (tuxlink-3m0vx) ([3e21b00](https://github.com/cameronzucker/tuxlink/commit/3e21b00f23b19b5cb7b204cb11b79bad7077f404))
* **radio:** adopt Select/Field wrappers on radio-pane config controls + drop dead -sm CSS (tuxlink-3m0vx) ([f7f00f5](https://github.com/cameronzucker/tuxlink/commit/f7f00f5e8b52e3a35afe7ff99b83ce757fa4131d))
* **shell:** adopt Button wrapper on the ribbon Connect/Abort (tuxlink-3m0vx) ([af69d5e](https://github.com/cameronzucker/tuxlink/commit/af69d5e15a0f3fb2a5ef59ae408a8902eaca38e4))
...
* **ardop:** bundle ardopcf 2.0.3.2.1 (implements CODEC) instead of 1.0.4.1.3 (tuxlink-y061) ([e6a6535](https://github.com/cameronzucker/tuxlink/commit/e6a65359dd96856e94c72cdfdfb6f22e93c9b9ec))
